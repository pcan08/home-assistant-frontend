...
| ------------------ | -------------------------------------------------------------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| appearance         | "material" / "outlined"                                        | "material" | Visual style. `"material"` shows a filled background with a bottom line; `"outlined"` shows a border on all sides. Defaults to the `--ha-form-appearance` theme token if not set explicitly. |
